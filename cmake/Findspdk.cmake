...
if (spdk_INCLUDE_DIRS AND spdk_LINK_DIRECTORIES)
  set(spdk_FIND_QUIETLY TRUE)
else ()
...
foreach (component ${spdk_FIND_COMPONENTS})
  ...
  if (NOT spdk_INCLUDE_DIRS)
    set (spdk_INCLUDE_DIRS ${${prefix}_INCLUDE_DIRS})
  endif ()
...
if (spdk_INCLUDE_DIRS AND EXISTS "${spdk_INCLUDE_DIRS}/spdk/version.h")
  foreach(ver "MAJOR" "MINOR" "PATCH")
    file(STRINGS "${spdk_INCLUDE_DIRS}/spdk/version.h" spdk_VER_${ver}_LINE
...
if (spdk_FOUND AND NOT (TARGET spdk::spdk))
  ...
  set_target_properties (spdk::spdk
    PROPERTIES
      ...
      INTERFACE_INCLUDE_DIRECTORIES "${spdk_INCLUDE_DIRS}"
