...
export module seastar:core.with_timeout;
import :core.future;
...
SEASTAR_EXPORT template<typename ExceptionFactory = default_timeout_exception_factory, typename Clock, typename Duration, typename... T>
