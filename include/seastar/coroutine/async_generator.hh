...
template <typename Yielded>
struct async_generator_promise_base<Yielded>::yield_awaiter final {
...
template <typename Yielded>
struct async_generator_promise_base<Yielded>::copy_awaiter final {
        async_generator_promise_base* _promise;
        std::coroutine_handle<> _consumer;
